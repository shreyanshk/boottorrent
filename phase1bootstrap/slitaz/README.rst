...
.. (atrent) actually I'd like to add some package that could be useful, such as ssh (both client and server), netstat/ss, a smal web browser (there was midori, but also ncurses ones would be good), mc (midnight commander), tmux, if it does not fatten the image size
